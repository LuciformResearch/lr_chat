/**
 * Test simple de persistance des données de mémoire hiérarchique
...
export async function testMemoryPersistence(): Promise<void> {
  console.log('🧪 Test de persistance de la mémoire hiérarchique');
  ...
  try {
    ...
    for (const conv of testConversations) {
      await LocalStorage.addConversationEntry(conv);
    }
