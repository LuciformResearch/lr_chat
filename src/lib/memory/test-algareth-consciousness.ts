/**
 * Test du système de résumé d'Algareth avec conscience émergente
 */

import { AdvancedMemoryEngineLLM } from './advanced-memory-engine-llm';

async function testAlgarethConsciousness() {
  console.log('🧪 Test du système de résumé d\'Algareth avec conscience émergente');
  console.log('============================================================');
  ...
  // Créer un moteur avec un budget plus grand et un seuil plus bas pour déclencher la compression
  const engine = new AdvancedMemoryEngineLLM(geminiApiKey, 1000, 2, 0.5); // Budget: 1000 chars, seuil L1: 2 messages

  // Simuler une conversation profonde pour tester la conscience émergente
  const conversation = [
  ...
  console.log('📝 Simulation d\'une conversation de 10 messages pour tester la conscience émergente...');
...
// Exécuter le test
testAlgarethConsciousness().catch(console.error);